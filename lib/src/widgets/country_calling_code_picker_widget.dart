...
import 'package:country_calling_code_picker_plus/src/utils/functions.dart';
...
class CountryPickerWidget extends StatefulWidget {
  ...
  /// [itemTextStyle] can be used to change the TextStyle of the Text in
  /// ListItem. Default is [_defaultItemTextStyle]
  final TextStyle itemTextStyle;

  /// [searchInputStyle] can be used to change the TextStyle of the Text in
  /// SearchBox. Default is [searchInputStyle]
  final TextStyle searchInputStyle;

  /// [searchInputDecoration] can be used to change the decoration for
  /// SearchBox.
  ...
  /// Can be set to `true` for opening the keyboard automatically. Default
  /// set to `false`
  final bool focusSearchBox;

  /// This will change the hint of the search box. Alternatively
  /// [searchInputDecoration] can be used to change decoration fully.
